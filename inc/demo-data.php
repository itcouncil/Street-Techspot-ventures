...
function seed_svg_attachment( $title, $accent = '#00FFD1' ) {
	...
	$svg      = '<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="900" viewBox="0 0 1200 900"><defs><linearGradient id="bg" x1="0" y1="0" x2="1" y2="1"><stop stop-color="#fbfbfd"/><stop offset="1" stop-color="#eef1f4"/></linearGradient><linearGradient id="mark" x1="0" y1="0" x2="1" y2="1"><stop stop-color="' . esc_attr( $accent ) . '"/><stop offset="1" stop-color="#96A1AA"/></linearGradient></defs><rect width="1200" height="900" fill="url(#bg)"/><circle cx="960" cy="130" r="310" fill="' . esc_attr( $accent ) . '" opacity=".08"/><circle cx="180" cy="770" r="280" fill="#DDE3E8" opacity=".9"/><rect x="190" y="160" width="820" height="520" rx="58" fill="#fff" opacity=".78"/><rect x="240" y="214" width="720" height="412" rx="38" fill="#f5f5f7"/><path d="M320 310h560M320 450h560M420 250v430M780 250v430" stroke="#1d1d1f" stroke-opacity=".055" stroke-width="3"/><text x="600" y="430" fill="url(#mark)" font-family="Inter,Arial,sans-serif" font-size="116" font-weight="800" text-anchor="middle">' . esc_html( $initials ) . '</text><text x="600" y="520" fill="#1d1d1f" font-family="Inter,Arial,sans-serif" font-size="32" font-weight="700" text-anchor="middle">' . esc_html( $title ) . '</text><text x="600" y="575" fill="#6e6e73" font-family="Inter,Arial,sans-serif" font-size="22" text-anchor="middle">Street Techspot Ventures</text></svg>';
